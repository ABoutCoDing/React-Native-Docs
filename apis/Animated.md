...
애니메이션 구성에서 `useNativeDriver : true` 로 지정하여 기본 드라이버를 사용할 수 있습니다.  자세한 내용은 [Animation](https://facebook.github.io/react-native/docs/animations#using-the-native-driver) 안내서를 참조하십시오.
